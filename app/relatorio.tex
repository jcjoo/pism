...
\begin{figure}[htb]
  ...
  \begin{minipage}{0.35\textwidth}
    \centering
    \includegraphics[width=\linewidth]{TelaInicial}\\[4pt]
    {\footnotesize (a) Tela inicial — dashboard}
  \end{minipage}\qquad
  \begin{minipage}{0.35\textwidth}
    \centering
    \includegraphics[width=\linewidth]{BarraDeNavegaçao}\\[4pt]
    {\footnotesize (b) Barra de navegação inferior}
  \end{minipage}
  \caption{Visão geral da interface do SalesPro}
